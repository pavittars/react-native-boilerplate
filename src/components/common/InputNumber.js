...
const InputNumber = (props) => {
    return (
        <View>
            ...
            <TextInput keyboardType='numeric' maxLength={10} style={{height:moderateScale(45), fontSize:moderateScale(20), marginTop:moderateScale(16), paddingBottom:moderateScale(8), borderBottomWidth:moderateScale(1), borderColor: '#DBDAEA'}} placeholderTextColor="#999999" placeholder={props.placeholder} value={props.value} onChangeText={(text)=>props.onMutate(text)} />
        </View>
    )
}
